...
var _opaqueName = /*#__PURE__*/(0, _classPrivateFieldLooseKey2.default)("opaqueName");
...
class WrapperKeepOpaque extends _Bytes.Bytes {
  constructor(registry, typeName, value) {
    ...
    Object.defineProperty(this, _opaqueName, {
      writable: true,
      value: void 0
    });
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _opaqueName)[_opaqueName] = opaqueName;
  }
  ...
  inspect() {
    return (0, _classPrivateFieldLooseBase2.default)(this, _decoded)[_decoded] ? {
      inner: [(0, _classPrivateFieldLooseBase2.default)(this, _decoded)[_decoded].inspect()],
  ...
  unwrap() {
    return (0, _util.assertReturn)((0, _classPrivateFieldLooseBase2.default)(this, _decoded)[_decoded], () => `${(0, _classPrivateFieldLooseBase2.default)(this, _opaqueName)[_opaqueName]}: unwrapping an undecodable value`);
  }
