      ...
      Object.defineProperty(this, _observeStatus, {
        ...
        value: (txHash, status) => {
          ...
          return api.derive.tx.events(blockHash).pipe((0, _rxjs.map)(_ref3 => {
            ...
            return (0, _classPrivateFieldLooseBase2.default)(this, _transformResult)[_transformResult](new _Result.SubmittableResult({ ...(0, _index.filterEvents)(txHash, block, events, status),
              status,
              txHash
            }));
