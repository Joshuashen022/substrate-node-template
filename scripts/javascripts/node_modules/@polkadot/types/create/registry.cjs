...
class TypeRegistry {
  ...
  getUnsafe(name, withUnknown, knownTypeDef) {
    let Type = (0, _classPrivateFieldLooseBase2.default)(this, _classes)[_classes].get(name) || (0, _classPrivateFieldLooseBase2.default)(this, _knownDefaults)[_knownDefaults][name]; // we have not already created the type, attempt it
  ...
  getClassName(Type) {
    ...
    for (const [name, Clazz] of Object.entries((0, _classPrivateFieldLooseBase2.default)(this, _knownDefaults)[_knownDefaults])) {
      if (Type === Clazz) {
        names.push(name);
      }
    }
  ...
  hasClass(name) {
    return (0, _classPrivateFieldLooseBase2.default)(this, _classes)[_classes].has(name) || !!(0, _classPrivateFieldLooseBase2.default)(this, _knownDefaults)[_knownDefaults][name];
  }
