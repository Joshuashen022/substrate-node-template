...
var _getBlockHash = /*#__PURE__*/(0, _classPrivateFieldLooseKey2.default)("getBlockHash");
...
class RpcCore {
  ...
  constructor(instanceId, registry, provider) {
    ...
    Object.defineProperty(this, _getBlockHash, {
      writable: true,
      value: void 0
    });
  ...
  setResolveBlockHash(resolveBlockHash) {
    (0, _classPrivateFieldLooseBase2.default)(this, _getBlockHash)[_getBlockHash] = (0, _util.memoize)(resolveBlockHash, {
      getInstanceId: () => (0, _classPrivateFieldLooseBase2.default)(this, _instanceId)[_instanceId]
    });
  }
  ...
  _createMethodSend(section, method, def) {
    ...
    const callWithRegistry = async (isScale, values) => {
      ...
      const blockHash = blockId && def.params[hashIndex].type === 'BlockNumber' ? await ((_classPrivateFieldLoo = (_classPrivateFieldLoo2 = (0, _classPrivateFieldLooseBase2.default)(this, _getBlockHash))[_getBlockHash]) === null || _classPrivateFieldLoo === void 0 ? void 0 : _classPrivateFieldLoo.call(_classPrivateFieldLoo2, blockId)) : blockId;
      const {
        registry
